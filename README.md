...
![正常还款测试](./_media/正常还款测试.png)

**提前还款测试用例**

![提前还款测试](./_media/提前还款测试.png)
...
![注册成功测试用例](./_media/注册.png)

**注册失败测试用例**

![注册失败测试用例](./_media/已注册.PNG)


## 7. 前端界面

**系统首页**
![系统首页](./_media/系统首页.png)

**还款计划表页面**
![还款计划表](./_media/还款计划表.png)

**贷款申请页面**
![贷款申请页面](./_media/贷款申请前端.png)
